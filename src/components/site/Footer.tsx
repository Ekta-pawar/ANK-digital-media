      ...
      <div className="relative mx-auto max-w-7xl px-6 py-16">
        ...
        <div className="mt-10 grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          {COLS.map((c, ci) => (
            ...
            >
              <h3 className="font-display text-sm font-bold uppercase tracking-[0.16em] text-primary">{c.title}</h3>
          ...
          >
            <h3 className="font-display text-sm font-bold uppercase tracking-[0.16em] text-primary">Contact Us</h3>
            <ul className="mt-4 space-y-3 text-sm text-muted-foreground">
              <li className="flex items-start gap-2">
                <Phone className="mt-0.5 h-4 w-4 shrink-0 text-primary" />
                <a href="tel:+919999779817" className="hover:text-primary">+91 99997 79817</a>
              </li>
              <li className="flex items-start gap-2">
