    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-6">
        ...
        <motion.p
          ...
          className="mt-4 max-w-xl text-[15px] leading-relaxed text-white/75"
        >
          Join a New Delhi-based team of designers, developers and marketers building web, marketing
...
export function ServiceDetailBanner({ icon: Icon, category, title, description }) {
  return (
